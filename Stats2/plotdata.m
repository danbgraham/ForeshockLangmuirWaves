...
fn=figure;
set(fn,'Position',[10 10 1300 600])
h(1)=axes('position',[0.05 0.09 0.26 0.85]); % [x y dx dy]
h(2)=axes('position',[0.38 0.09 0.26 0.85]); % [x y dx dy]
h(3)=axes('position',[0.71 0.09 0.26 0.85]); % [x y dx dy]
ud=get(fn,'userdata');
...
hold(h(1),'off');
xlabel(h(1),'D_f (R_E)','fontsize',16)
ylabel(h(1),'R (R_E)','fontsize',16)
title(h(1),'Counts','fontsize',16);
set(gcf,'color','w')
irf_legend(h(1),'(a)',[0.04 0.98],'fontsize',18)
...
hold(h(2),'off');
xlabel(h(2),'D_f (R_E)','fontsize',16)
ylabel(h(2),'R (R_E)','fontsize',16)
title(h(2),'E_{max} > 0.1 mV m^{-1} Percentage','fontsize',16);
set(gcf,'color','w')
irf_legend(h(2),'(b)',[0.04 0.98],'fontsize',18)
...
hold(h(3),'off');
xlabel(h(3),'D_f (R_E)','fontsize',16)
ylabel(h(3),'R (R_E)','fontsize',16)
title(h(3),'E_{max} > 1 mV m^{-1} Percentage','fontsize',16);
set(gcf,'color','w')
irf_legend(h(3),'(c)',[0.04 0.98],'fontsize',18)
axis(h(3),[-20 50 -50 50])

set(h(1:3),'fontsize',16)

%% Scatterplots of electric field versus Df
...
fn=figure;
set(fn,'Position',[10 10 700 750])
h(1)=axes('position',[0.09 0.725 0.89 0.26]); % [x y dx dy]
h(2)=axes('position',[0.09 0.395 0.89 0.26]); % [x y dx dy]
h(3)=axes('position',[0.09 0.065 0.89 0.26]); % [x y dx dy]
ud=get(fn,'userdata');
ud.subplot_handles=h;
set(fn,'userdata',ud);
set(fn,'defaultLineLineWidth',2); 
...
plot(h(1),FScoords(idx2,1),Emax(idx2),'k.')
hold(h(1),'on')
plot(h(1),Dfvec,Emaxmean,'r','linewidth',2)
plot(h(1),Dfvec,Emaxmedian,'g','linewidth',2)
plot(h(1),[0 0],[1e-2 1e3],'m--','linewidth',2)
hold(h(1),'off')
xlabel(h(1),'D_f (R_E)','interpreter','tex','fontsize',14)
ylabel(h(1),'E_{max} (mV m^{-1})','interpreter','tex','fontsize',14)
set(h(1),'fontsize',14)
irf_legend(h(1),'mean',[0.90, 0.98],'fontsize',14,'color','r');
irf_legend(h(1),'median',[0.90, 0.88],'fontsize',14,'color','g');
irf_legend(h(1),'(a)',[0.98, 0.98],'fontsize',14,'color','k');
set(h(1),'yscale','log')
axis(h(1),[-15 50 1e-2 3e2])

plot(h(2),FScoords(idx2,1),Emaxpar(idx2),'k.')
hold(h(2),'on')
plot(h(2),Dfvec,Emaxparmean,'r','linewidth',2)
plot(h(2),Dfvec,Emaxparmedian,'g','linewidth',2)
plot(h(2),[0 0],[1e-2 1e3],'m--','linewidth',2)
hold(h(2),'off')
xlabel(h(2),'D_f (R_E)','interpreter','tex','fontsize',14)
ylabel(h(2),'E_{||,max} (mV m^{-1})','interpreter','tex','fontsize',14)
set(h(2),'fontsize',14)
irf_legend(h(2),'(b)',[0.98, 0.98],'fontsize',14,'color','k');
set(h(2),'yscale','log')
axis(h(2),[-15 50 1e-2 3e2])

plot(h(3),FScoords(idx2,1),Emaxperp(idx2),'k.')
hold(h(3),'on')
plot(h(3),Dfvec,Emaxperpmean,'r','linewidth',2)
plot(h(3),Dfvec,Emaxperpmedian,'g','linewidth',2)
plot(h(3),[0 0],[1e-2 1e3],'m--','linewidth',2)
hold(h(3),'off')
xlabel(h(3),'D_f (R_E)','interpreter','tex','fontsize',14)
ylabel(h(3),'E_{\perp,max} (mV m^{-1})','interpreter','tex','fontsize',14)
set(h(3),'fontsize',14)
irf_legend(h(3),'(c)',[0.98, 0.98],'fontsize',14,'color','k');
set(h(3),'yscale','log')
axis(h(3),[-15 50 1e-2 3e2])
...
h(1)=axes('position',[0.05 0.18 0.275 0.8]); % [x y dx dy]
h(2)=axes('position',[0.385 0.18 0.275 0.8]); % [x y dx dy]
h(3)=axes('position',[0.72 0.18 0.275 0.8]); % [x y dx dy]
ud=get(fn,'userdata');
ud.subplot_handles=h;
set(fn,'userdata',ud);
set(fn,'defaultLineLineWidth',2); 
...
fn=figure;
%set(fn,'Position',[10 10 1000 350])
%h(1)=axes('position',[0.06 0.16 0.43 0.8]); % [x y dx dy]
%h(2)=axes('position',[0.55 0.16 0.43 0.8]); % [x y dx dy]
set(fn,'Position',[10 10 1100 300])
h(1)=axes('position',[0.05 0.18 0.275 0.8]); % [x y dx dy]
h(2)=axes('position',[0.385 0.18 0.275 0.8]); % [x y dx dy]
h(3)=axes('position',[0.72 0.18 0.275 0.8]); % [x y dx dy]
...
loglog(h(1),10.^ElD1,PlD1,'linewidth',2)
hold(h(1),'on')
loglog(h(1),10.^ElD2,PlD2,'linewidth',2)
loglog(h(1),10.^ElD3,PlD3,'linewidth',2)
loglog(h(1),10.^ElD4,PlD4,'linewidth',2)
loglog(h(1),10.^ElD5,PlD5,'linewidth',2)
%loglog(h(1),10.^ElD6,PlD6,'linewidth',2)
loglog(h(1),10.^logEvec,PSGTDf1,'--','linewidth',2,'color',color1)
loglog(h(1),10.^logEvec,PSGTDf2,'--','linewidth',2,'color',color2)
loglog(h(1),10.^logEvec,PSGTDf3,'--','linewidth',2,'color',color3)
loglog(h(1),10.^logEvec,PSGTDf4,'--','linewidth',2,'color',color4)
loglog(h(1),10.^logEvec,PSGTDf5,'--','linewidth',2,'color',color5)
%loglog(h(1),10.^logEvec,PSGTDf6,'--','linewidth',2,'color',color6)
hold(h(1),'off')
xlabel(h(1),'E_{max} (mV m^{-1})','interpreter','tex','fontsize',14)
ylabel(h(1),'P(log E_{max})','interpreter','tex','fontsize',14)
axis(h(1),[1e-2 3e2 1 2e3])
legend(h(1),{'0 < D_f/R_E < 2','2 < D_f/R_E < 4','4 < D_f/R_E < 6','6 < D_f/R_E < 8','8 < D_f/R_E < 10'},'location','southwest')
irf_legend(h(1),'(a)',[0.99 0.99],'color','k','fontsize',14)

loglog(h(2),10.^ElD1par,PlD1par,'linewidth',2)
hold(h(2),'on')
loglog(h(2),10.^ElD2par,PlD2par,'linewidth',2)
loglog(h(2),10.^ElD3par,PlD3par,'linewidth',2)
loglog(h(2),10.^ElD4par,PlD4par,'linewidth',2)
loglog(h(2),10.^ElD5par,PlD5par,'linewidth',2)
%loglog(h(2),10.^ElD6,PlD6,'linewidth',2)
loglog(h(2),10.^logEvec,PSGTDf1par,'--','linewidth',2,'color',color1)
loglog(h(2),10.^logEvec,PSGTDf2par,'--','linewidth',2,'color',color2)
loglog(h(2),10.^logEvec,PSGTDf3par,'--','linewidth',2,'color',color3)
loglog(h(2),10.^logEvec,PSGTDf4par,'--','linewidth',2,'color',color4)
loglog(h(2),10.^logEvec,PSGTDf5par,'--','linewidth',2,'color',color5)
%loglog(h(2),10.^logEvec,PSGTDf6,'--','linewidth',2,'color',color6)
hold(h(2),'off')
xlabel(h(2),'E_{||,max} (mV m^{-1})','interpreter','tex','fontsize',14)
ylabel(h(2),'P(log E_{||,max})','interpreter','tex','fontsize',14)
axis(h(2),[1e-2 3e2 1 2e3])
irf_legend(h(2),'(b)',[0.99 0.99],'color','k','fontsize',14)

loglog(h(3),10.^ElD1perp,PlD1perp,'linewidth',2)
hold(h(3),'on')
loglog(h(3),10.^ElD2perp,PlD2perp,'linewidth',2)
loglog(h(3),10.^ElD3perp,PlD3perp,'linewidth',2)
loglog(h(3),10.^ElD4perp,PlD4perp,'linewidth',2)
loglog(h(3),10.^ElD5perp,PlD5perp,'linewidth',2)
%loglog(h(3),10.^ElD6,PlD6,'linewidth',2)
loglog(h(3),10.^logEvec,PSGTDf1perp,'--','linewidth',2,'color',color1)
loglog(h(3),10.^logEvec,PSGTDf2perp,'--','linewidth',2,'color',color2)
loglog(h(3),10.^logEvec,PSGTDf3perp,'--','linewidth',2,'color',color3)
loglog(h(3),10.^logEvec,PSGTDf4perp,'--','linewidth',2,'color',color4)
loglog(h(3),10.^logEvec,PSGTDf5perp,'--','linewidth',2,'color',color5)
%loglog(h(3),10.^logEvec,PSGTDf6,'--','linewidth',2,'color',color6)
hold(h(3),'off')
xlabel(h(3),'E_{\perp,max} (mV m^{-1})','interpreter','tex','fontsize',14)
ylabel(h(3),'P(log E_{\perp,max})','interpreter','tex','fontsize',14)
axis(h(3),[1e-2 3e2 1 2e3])
irf_legend(h(3),'(c)',[0.99 0.99],'color','k','fontsize',14)
%legend(h(3),{'-4 < D_f < -2','-2 < D_f < 0','0 < D_f < 2','2 < D_f < 4','4 < D_f < 6'},'location','northwest')
set(gcf,'color','w')