function [Eenvpar,Eenvperp] = calcenvelopepp(Exyz,fmin)
...
Eenvperp = sqrt(Eenv1.^2+Eenv2.^2);
Eenvpar = sqrt(Eenv3.^2);
Eenvperp = irf.ts_scalar(Exyz.time,Eenvperp);
Eenvpar = irf.ts_scalar(Exyz.time,Eenvpar);
