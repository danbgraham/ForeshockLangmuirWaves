...
load('pearsondataEperp.mat'); 

NN = pearsondataEperp.NN;
dlogE = pearsondataEperp.difflogE;

Chi2SGTmomsr = pearsondataEperp.Chi2SGTmomsr;
Chi2SGTfitr = pearsondataEperp.Chi2SGTfitr;
Chi2pearsmomsr = pearsondataEperp.Chi2pearsmomsr;
Chi2pearsfitr = pearsondataEperp.Chi2pearsfitr;
...
Chi2SGTmoms = pearsondataEperp.Chi2SGTmoms;
Chi2SGTfit = pearsondataEperp.Chi2SGTfit;

%% Calculate 2D histograms
histChi2SGT = mean2dhist(log10(Chi2SGTmomsr),log10(Chi2SGTfitr),log10(Chi2SGTfitr),[0.5 4.5],[0.5 4.5],60);
countsSGT = histChi2SGT.countshist;
countsSGT(countsSGT == 0) = NaN;
xvecSGT = 10.^histChi2SGT.xvec;
yvecSGT = 10.^histChi2SGT.yvec;

histChi2pears = mean2dhist(log10(Chi2pearsmomsr),log10(Chi2pearsfitr),log10(Chi2pearsfitr),[0.5 4.5],[0.5 4.5],60);
...
histChi2moms = mean2dhist(log10(Chi2SGTmomsr),log10(Chi2pearsmomsr),log10(Chi2pearsmomsr),[0.5 4.5],[0.5 4.5],60);
countsmoms = histChi2moms.countshist;
countsmoms(countsmoms == 0) = NaN;
xvecmoms = 10.^histChi2moms.xvec;
yvecmoms = 10.^histChi2moms.yvec;

histChi2fit = mean2dhist(log10(Chi2SGTfitr),log10(Chi2pearsfitr),log10(Chi2pearsfitr),[0.5 4.5],[0.5 4.5],60);
