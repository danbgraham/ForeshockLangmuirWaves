...
load('pearsondataEpar.mat'); 

NN = pearsondataEpar.NN;
dlogE = pearsondataEpar.difflogE;

Chi2SGTmomsr = pearsondataEpar.Chi2SGTmomsr;
Chi2SGTfitr = pearsondataEpar.Chi2SGTfitr;
Chi2pearsmomsr = pearsondataEpar.Chi2pearsmomsr;
Chi2pearsfitr = pearsondataEpar.Chi2pearsfitr;
...
Chi2SGTmoms = pearsondataEpar.Chi2SGTmoms;
Chi2SGTfit = pearsondataEpar.Chi2SGTfit;
